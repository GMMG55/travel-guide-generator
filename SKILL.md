...
description: 自动生成精美旅游攻略HTML文档。当用户需要制定旅游计划、生成旅游攻略、规划行程时使用。支持：(1) 自动搜索小红书/马蜂窝获取真实攻略内容 (2) 使用高德API计算路线距离和用时 (3) 生成PC/移动端自适应的精美HTML (4) 包含每日详细行程、酒店推荐、美食推荐、避坑指南 (5) 高铁/飞机交通信息准确查询
---
...
1. **在线搜索真实攻略** - 搜索小红书、马蜂窝获取真实用户评价和推荐
